...
<body class="layout-${userProfile.layout_type}">
  ...
  <div class="container">
    ...
    <a href="https://getur.link" class="watermark" target="_blank">Powered by GetUrLink</a>
  </div>
...
app.use(async (req, res, next) => {
  ...
  // Main app hosts (and Railway preview domains) skip the custom-domain lookup
  // and fall through to the normal routes (landing page, /p/:username, API, etc.)
  const MAIN_HOSTS = ['localhost', '127.0.0.1', 'getur.link', 'www.getur.link', 'app.getur.link'];
  if (MAIN_HOSTS.includes(host) || host.endsWith('.up.railway.app')) {
    return next();
  }
...
// Landing page (root of the main domain)
app.get('/', (req, res) => {
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>GetUrLink — Your link in bio that actually sells</title>
  <meta name="description" content="A beautiful Bento-style link-in-bio storefront for creators. Sell digital products with 1-click checkout. Free until you make your first sale.">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn {
      ...
      padding: 0.65rem 1.25rem; font-size: 0.95rem; transition: all 0.25s ease;
      display: inline-block;
    }
    ...
    .hero {
      max-width: 820px; margin: 0 auto; padding: 5rem 1.5rem 4rem;
      text-align: center;
    }
    .pill {
      display: inline-block; font-size: 0.8rem; font-weight: 600;
      color: var(--text-muted); border: 1px solid var(--card-border);
      background: var(--card-bg); padding: 0.35rem 0.9rem; border-radius: 999px;
    ...
    h1 .grad {
      background: linear-gradient(120deg, #818cf8, #d946ef);
      -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
    }
    .sub { font-size: 1.15rem; color: var(--text-muted); max-width: 560px; margin: 0 auto 2.25rem; }
    ...
    footer {
      ...
      padding: 2.5rem 1.5rem 3rem; border-top: 1px solid var(--card-border);
    }
...
<body>
  <nav>
    <div class="logo">Get<span>Ur</span>Link</div>
    <div class="nav-actions">
      <a href="https://app.getur.link" class="btn btn-ghost">Log in</a>
      <a href="https://app.getur.link" class="btn btn-primary">Get started</a>
    </div>
  </nav>

  <section class="hero">
    <div class="pill">✨ Free until you make your first sale</div>
    <h1>Your link in bio that <span class="grad">actually sells</span></h1>
    <p class="sub">A beautiful Bento-style storefront for creators. Share your links and sell your digital products — presets, templates, e-books — with fast 1-click checkout.</p>
    <div class="cta-row">
      <a href="https://app.getur.link" class="btn btn-primary">Create your page — free</a>
  ...
  <section class="features" id="features">
    <div class="feature">
      ...
      <p>List presets, templates, or e-books and get paid instantly. Buyers get a secure download link the moment they pay.</p>
    </div>
    <div class="feature">
      <div class="icon">💸</div>
      <h3>Keep more of your money</h3>
      <p>No monthly wall before you've earned a cent. Start free with a low fee, upgrade to 0% fees when you're ready.</p>
    </div>
    <div class="feature">
      <div class="icon">✨</div>
      <h3>An assistant that sells for you</h3>
      <p>A built-in chat assistant answers buyer questions about your products and guides them straight to checkout — 24/7.</p>
    </div>
    <div class="feature">
      <div class="icon">🎨</div>
      <h3>Beautiful by default</h3>
      <p>Modern glassmorphism themes that look great on every phone. Your page, your brand, ready in minutes.</p>
    </div>
  </section>

  <footer>
    © ${new Date().getFullYear()} GetUrLink · <a href="https://app.getur.link">Create your page</a>
  </footer>
</body>
</html>`);
});
